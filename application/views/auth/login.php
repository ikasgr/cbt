...
<div class="container-fluid text-white" style="background:#00238f;background-size: contain;background-image: url('<?= base_url() ?>/assets/front_assets/images/header-bg.png');background-repeat: no-repeat;background-position: left; height:185px;position:relative;top:0px;left:0px;right:0px">
	  <div class="row">
...
<div class="wrapper"  style="margin-top:-65px;">
	<div id="formContent" style="background-size: 300px;background-image: url('<?= base_url() ?>/assets/front_assets/images/logo-w.png');background-repeat: no-repeat;background-position: top right; ">
...
<footer class="container text-center py-3">
	<small>COPYRIGHT &copy; <?php $tgl=date('Y'); echo $tgl; ?> | IKASMEDIA</small>
	<!--<small>Copyright  &copy; 2023| <?= $setting->sekolah ?></small> -->
</footer>

                    ...
                    <div class="card-footer">
                        ...
                        <ul>
                            ...
                            <?php if ($this->ion_auth->is_admin()) : ?>
                                <li>
                                    Ukuran file bisa dirubah dengan mengedit file:
                                    <pre class="p-1 m-1">/application/views/elearning/materi_add.php</pre>
                                    baris kode ke 62
                                </li>
                            <?php else: ?>
                                <li>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#picupload").on('change', function (e) {
            ...
            uploadAttach(base_url + 'elearning/uploadfile', form, maxSize);
        });
        ...
        $('#formmateri').submit(function (e) {
            ...
            let formData = new FormData($('#formmateri')[0]);
            ...
            $.ajax({
                url: base_url + 'elearning/savemateri',
                method: "POST",
                processData: false,
                contentType: false,
                data: formData,
    ...
    function onChangeGuru(idGuru) {
        ...
        $.ajax({
            type: 'GET',
            url: base_url + 'elearning/dataaddkelas/' + idGuru,
            //data: data,
            success: function (data) {
                arrKelasMapel = [];
    ...
    function onChangeKelas(kelas, e) {
        ...
        $.ajax({
            methode: 'GET',
            url: base_url + 'elearning/dataaddjadwal?mapel=' + selMapel.val() + '&kelas=' + kelas,
            success: function (data) {
                for (let i = 0; i < data.length; i++) {
    ...
    function uploadFileSummernote(file) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'elearning/uploadfile',
            data: data,
    ...
    function deleteImage(pos, elm, src) {
        ...
        let formData = new FormData($('#csrf')[0]);
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    ...
                    data: formData,
                    type: "POST",
                    url: base_url + "elearning/deletefile",
                    cache: false,

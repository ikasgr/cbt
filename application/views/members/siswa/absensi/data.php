                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class='float-left'>
                                <a href='#' onclick="window.history.back();" class='btn btn-danger btn-sm'><i class='fa fa-arrow-left'></i></a>
                            </div>                         
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-12">
								<div class="card bg-dark text-white shadow-lg rounded-lg">
									<img class="card-img" src="<?= base_url() ?>/assets/img/class-big-absen.jpg" alt="Card image">
							...
							<div class="col-sm-12 mt-3">
								<div class="d-flex justify-content-center">
									<div class="col-sm-3 col-md-3 col-4">
										<a href="<?=base_url()?>dashboard" id="btn-kembali-selesai" class="btn btn-success doblockui" role="button"><i class='fa fa-arrow-left'></i> KEMBALI</a>
									</div>
									<div class="col-sm-3 col-md-3 col-4">
										<a href="#" id="btn-kembali-selesai" class="btn btn-danger" role="button" onclick="logout()">LOGOUT  <i class='fa fa-sign-out'></i></a>
									</div>                                                
								</div>
							</div>
            </div>

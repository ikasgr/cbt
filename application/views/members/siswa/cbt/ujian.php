	...
	<main>
	    ...
	    <header class="masthead">
	        <?php $this->load->view('members/siswa/templates/top_ujian.php'); ?>
	    </header>
	    ...
	    <div class="container-fluid">
	        <div class="main-content">
	            <div class="row no-gutters">
	                ...
	                <div class="col-md-10">
	                    <div class="content questions-page mt-2">
	                        <div id="questionHeader" class="row no-gutters">
	                            <div class="col-6 col-sm-6 col-md-6 col-lg-3 col">
	                                <h3 class="question-heading">Soal nomor <strong><a id="nomor-soal"></a></strong></h3>
	                            </div>
	                            <div class="col-6 col-sm-6 col-md-6 col-lg-4 col">

	                            </div>
	                            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col">
	                                <div class="question-header-info">
	                                    <div class="float-right question-list">
	                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#daftarModal">Daftar<br>Soal</a>
	                                    </div>
	                                    <div class="float-right remaining-time">
	                                        <div class="widget-timer">
	                                            <span>Sisa Waktu :</span>
	                                            <span id="timer" style="font-size:18px"><b>00:00:00</b></span>
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
	                        ...
	                        <div class="sizing-text">
	                            <div class="row no-gutters">
	                                <div class="float-left">Ukuran font soal:</div>
	                                <ol class="float-left sizing-text-list">
	                                    <li><a id="minus" style="font-size:14px; text-decoration:none; cursor: pointer">A</a></li>
	                                    <li class="current"><a id="normal" style="font-size:16px; text-decoration:none; cursor: pointer">A</a></li>
	                                    <li><a id="plus" style="font-size:18px; text-decoration:none; cursor: pointer">A</a></li>
	                                </ol>
	                            </div>
	                        </div>
	                        <section class="page-section main-section">
	                            <!-- soal start -->
	                            <div id="pnlKeteranganSoal" style="border-color: #E0E0E0; border-style: Solid;">
	                                <div id="examketerangancontent" class="Section1"></div>
	                            </div>
	                            <div id="pnlSoal" style="border-color: #E0E0E0; border-style: Solid;padding: 30px">
	                                <div id="examcontent" class="Section1">
	                                    <div id="box-soal" style="font-size:12pt;">
	                                        <div class="konten-soal-jawab"> <!--Konten Soal -->
	                                    ...
	                                    <p id="capgomeh" style="margin-top: 5px !important; font-size: 22px !important; font-weight: bold; border-width: 4px; border-color: purple; border-style: solid; width: 210px; padding-left: 20px; margin-left: 20px ">
	                                        <font style="color:purple">D</font>
	                                        <font style="color:red">I</font>
	                                        <font style="color:orange">S</font>
	                                        <font style="color:maroon">D</font>
	                                        <font style="color:red">I</font>
	                                        <font style="color:green">K</font>
	                                        <font style="color:orange">N</font>
	                                        <font style="color:black">T</font>
	                                        <font style="color:maroon">T</font>
	                                    </p>
	                                </div>
	                            </div>
	                            <!-- end soal -->
	                        ...
	                        <div class="card-footer no-gutters">
	                            <div class="d-flex justify-content-between bd-highlight">
	                                ...
	                                <div class="bd-highlight">
	                                    <button class="btn btn-primary btn-oval-sm doblockui" id="prev" onclick="prevSoal()">
	                                ...
	                                <div class="bd-highlight">
	                                    ...
	                                    <button class="btn btn-oval-sm doblockui" id="next" onclick="nextSoal()">
	    ...
	    <footer>
	        <div class="container-fluid">
	            <div class="row no-gutters">
	                <div class="col-md-12">
	                    <div class="copyright">COPYRIGHT &copy; <?php $tgl = date('Y'); echo $tgl; ?> | IKASMEDIA </div>
	                </div>
	            </div>
	        </div>
	    </footer>

<div class="modal fade" id="daftarModal" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
...
<script>
        ...
        $(document).keydown(function (event) {
            ...
            if (charCode == 27 || charCode == 91 || charCode == 92) {
	            ...
	            swal.fire({
	                ...
	                imageUrl: "<?= base_url() ?>/assets/img/welcome-asesmen.jpg",
	                html: "<span class='badge badge-success'> 1. </span> Selesaikan Asesmen dengan  <span class='badge badge-success'> JUJUR </span> <br> <span class='badge badge-success'> 2. </span> Kamu akan <span class='badge badge-warning'> DIALIHKAN </span> ke mode fullscreen! <br><span class='badge badge-success'> 3. </span> Selama Asesmen <span class='badge badge-danger'> DILARANG KELUAR </span> mode fullscreen!",
	                ...
	                if (document.webkitIsFullScreen === false) {
	                    ...
	                    timer = setInterval(function() {
	                        ...
	                        if (closeInSeconds < 0) {
                                ...
                                window.location = base_url + "siswa/leavecbt/<?= $jadwal->id_jadwal ?>/<?= $siswa->id_siswa ?>";
	                        }
	                        $('.swal2-content').text(displayText.replace(/#1/, closeInSeconds));
	                    }, 1000);
	                    swal.fire({
	                        title: "Dilarang keluar dari mode fullscreen!",
	                        imageUrl: "<?= base_url() ?>/assets/img/warning.png",
	                        text: displayText.replace(/#1/, closeInSeconds),
	                        timer: closeInSeconds * 2000,
	                        timerProgressBar: true,
	                        confirmButtonColor: "#DD6B55",
	                        confirmButtonText: 'Ok, Lanjut Asesmen',
	                        type: "warning",
	                        allowOutsideClick: false
	                    }).then((result) => {
	                        if (result.value) {
    ...
    function transformToFormData(data, formData=(new FormData), parentKey=null) {
        ...
        return formData
    	        ...
    	        function BlokirKeluar() {
	            swal.fire({
	                title: "<h1> M A A F ! </h1>",
	                html: "Anda tidak di ijinkan <b>logout</b> dari aplikasi. Silahkan selesaikan semua soal dalam tes ini kemudian klik tombol <span class='badge badge-success'> SELESAI <i class='fa fa-check-circle' ></i> </span> !",
	                allowOutsideClick: false,
	                confirmButtonColor: "#3085d6",
	                confirmButtonText: "OK"
	            }).then(result => {

            ...
            <div class="col-md-1"></div>
				<div class="col-md-10">
							...
							<div class="col-sm-12">
								<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
										...
										<li class="breadcrumb-item active" aria-current="page">Catatan Guru</li>
								  </ol>
								</nav>							
							</div>
						</div>
                    ...
                    <div class="card">
                        ...
                        <h5 class="text-center "> CATATAN GURU </h5>
                        </div>
                        <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-3">
								<div class="card bg-dark text-white shadow-lg rounded-lg">
									<img class="card-img" src="<?= base_url() ?>uploads/settings/banner3.jpg" alt="Card image">

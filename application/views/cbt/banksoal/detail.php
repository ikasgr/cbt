...
$timeshow = date('d-m-Y', strtotime($ftw)); // Format tanggal
$timeshow2 = date("H:i", strtotime($ftw));  // Format jam dan menit
...
$jam = floor($diff / (60 * 60));        // Total jam dari selisih waktu
$menit = floor(($diff % (60 * 60)) / 60); // Sisa menit setelah jam dihitung
$diff2 = $waktu_sekarang - $waktu_selesai;

if (!$this->ion_auth->is_admin() && ($nselesai < $nsekarang)) {
    $dnone = 'd-none';
} else {
    $dnone = '';
};
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank) ?>"
                           type="button" class="btn btn-sm btn-success <?=$dnone?>">
                            ...
                            <?php if ($total_pg > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary ml-3 <?=$dnone?>" id="save-pg">
                                            <i class="fa fa-save"></i> <span class="d-none d-md-inline-block ml-1">Simpan Soal Terpilih</span>
                                        </button>
                                    </div>
                                </div>
                                            ...
                                            <div class="rTableRow">
                                                ...
                                                <div class="rTableCell text-right pt-2" style="width: 60px">
                                                    <a href="<?= base_url('cbtbanksoal/buatsoal/' . $bank->id_bank . '?no=' . $s->nomor_soal . '&jns=1') ?>"
                                                       type="button" class="btn btn-sm btn-default mb-2 <?=$dnone?>">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    <button class="btn btn-sm btn-default <?=$dnone?>"
                                                            type="button"
                            ...
                            <?php if ($total_pg2 > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary ml-3 <?=$dnone?>" id="save-pg2">
                            ...
                            <?php if ($total_jodohkan > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary ml-3 <?=$dnone?>" id="save-jodohkan">
                                            <i class="fa fa-save"></i> <span class="d-none d-sm-inline-block ml-1">Simpan Soal Terpilih</span>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <?php if ($total_isian > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary ml-3 <?=$dnone?>" id="save-isian">
                                            <i class="fa fa-save"></i> <span class="d-none d-sm-inline-block ml-1">Simpan Soal Terpilih</span>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <?php if ($total_essai > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between mb-3">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary ml-3 <?=$dnone?>" id="save-essai">

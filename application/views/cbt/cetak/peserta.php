        ...
        for (let a = 0; a < pages; a++) {
            ...
            if (a === 0) {
                card += '<div style="display: flex; justify-content: center; align-items: center;">\n' +
                    ...
                    '        <tr>\n' +
                    '       <td style="width:15%;">' +
                    '       <img alt="logo kiri" id="prev-logo-kanan-print" src="../uploads/settings/kopsekolah.jpg" style=" height:125px; margin: 6px;">' +
                    '       </td>' +
            ...
            for (let i = t; i < end; i++) {
                var td = '<div style="display: flex; justify-content: center; align-items: center;">' +
                    ...
                    '<tr style="line-height: 1; font-family: \'Verdana\'; font-size: 12pt">' +

    ...
    function createPrintPreview(data) {
        ...
        for (let a = 0; a < pages; a++) {
            ...
            card += '<table style="width: 100%; border: 0;">' +
                '<tr>' +
				'<img  src="../uploads/settings/kopsekolah.jpg" style=" height:125px; margin: 6px;">' +
                '</tr>' +
                '</table>' +
                ...
                '<tbody>' +
                '<tr style="line-height: 1.1;font-family: \'Verdana\';">' +
                ...
                '</tr>' +
                '<tr style="line-height: 1.1;font-family: \'Verdana\';">' +
                '<td>Waktu</td><td>:</td><td>_____s/d_____</td>' +
                '</tr>' +
                '</tbody>' +
                '</table>' +
                '</div>' +
            ...
            for (let i = t; i < end; i++) {
                ...
                card += '<tr style="font-family: \'Verdana\'; font-size: 10pt">' +
            ...
            if (a === (pages - 1)) {
                card += '</table>' +
                    ...
                    '<tr style="line-height: 1.1;font-family: \'Verdana\';font-size: 10pt">' +

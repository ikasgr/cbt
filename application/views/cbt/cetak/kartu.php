                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="header-2" class="form-control" name="header_2" rows="2"
                                          placeholder="SMA NEGERI 2 AMFOANG TIMUR"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="header-3" class="form-control" name="header_3" rows="2"
                                          placeholder="Jln. Vetor Kameo - Nunuanah, 85371"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="header-4" class="form-control" name="header_4" rows="2"
                                          placeholder="KARTU PESERTA ASESMEN"
                                          required><?= isset($kartu->header_4) ? $kartu->header_4 : '' ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Tanggal</label>
                                <input id="input-tanggal" class="form-control" name="tanggal" placeholder="5 Oktober 1988"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:60%;">
                                                <div id="prev-header-1" class="text-center"
                                                     style="line-height: 1.1; font-family: 'Verdana'; font-size: 9pt"><?= isset($kartu->header_1) ? $kartu->header_1 : '' ?></div>
                                                <div id="prev-header-2" class="text-center"
                                                     style="line-height: 1.1; font-family: 'Verdana'; font-size: 10pt">
                                                    <b><?= isset($kartu->header_2) ? $kartu->header_2 : '' ?></b></div>
                                                <div id="prev-header-3" class="text-center"
                                                     style="line-height: 1.2; font-family: 'Verdana'; font-size: 8pt"><?= isset($kartu->header_3) ? $kartu->header_3 : '' ?></div>
                                                <div id="prev-header-4" class="text-center"
                                                     style="line-height: 1.2; font-family: 'Verdana'; font-size: 8pt"><?= isset($kartu->header_4) ? $kartu->header_4 : '' ?></div>
                                            </td>
                                            <td style="width:20%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <div id="prev-tandatangan"
                                                     style="font-family: 'Verdana'; font-size: 9pt; line-height: 1; background: url('<?= base_url() . $setting->stampel ?>') no-repeat center; background-size: 100px 60px">
...
<script>
    ...
    var tandatangan = "<?=base_url() . $setting->stampel?>";
        ...
        if (data.length > 8) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                var td = '<div style="display: flex; justify-content: center; align-items: center;">' +
                    ...
                    '</td>' +
                    '<td style="text-align: center;">' +
                    '<div id="prev-tandatangan-print" style="font-family: \'Verdana\'; font-size: 9pt; line-height: 1; background: url(' + tandatangan + ') no-repeat center; background-size: 120px 80px">' +
                    '<span>' + oldKota + '</span>, <span>' + oldTgl + '</span>' +
                    '<br>Kepala ' + satuanPend +
                    '<br>' +
                    '<br>' +

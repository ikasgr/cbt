                                        ...
                                        <div class="border my-shadow mb-3 p-4 bg-white">
                                            <div class="pt-4"
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center;">
                                                        ...
                                                        <img class="center" alt="kop sekolah" id="prev-kop-sekolah-print" src="../uploads/settings/kopsekolah.jpg" style=" height:105px; margin: 6px;">

                                                    
                                                </div>
                                                <div style="line-height: 1.1;font-size: 16pt; text-align: center;"><b>DAFTAR PESERTA</b></div>
                                                <div style="line-height: 1.1;font-size: 14pt; text-align: center;" class="jenis-ujian"> (PILIH JENIS UJIAN) </div>
                                                <?php

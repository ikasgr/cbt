                        ...
                        <div style="display: flex; justify-content: center; align-items: center;">
                            <div id="print-preview" style="width: 21cm; min-height: 29cm;" class="border my-shadow p-5">
								<table id="table-header-print"
									...
									<tr>
										<td>
										<img alt="kop sekolah" id="prev-kop-sekolah-print" src="../uploads/settings/kopsekolah.jpg" style=" height:125px; margin: 6px;">
										</td>
									</tr>
								</table>
                                <br >
								<div style="display: flex; justify-content: center; line-height: 1.1; font-family: 'Verdana'; font-size: 14pt">BERITA ACARA</div>
								<br>                                
                                ...
                                <table style="width: 100%;font-family: 'Verdana';">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" style="height: 100px; border: 1px solid black; padding: 12px"
                                            class="editable bg-gray-light" id="edit-catatan">										    
                                            Pelaksanaan ujian berjalan dengan aman, lancar dan tertib.<br>
										    Terdapat siswa an. .... yang tidak hadir karena ....<br>
										    Catatan lain yang perlu .....</td>
                                    </tr>
                                </table>
                                <br>
                                <br>
                                ...
                                <br>
                                <div id="berita-ttd">
                                    <table style="width:90%; font-family: 'Verdana';">
                                        <tr>
                                            <th></th>
                                            <th></th>
                                            <th></th>
...
<script>
    ...
    function previewTTD(pengawas) {
        ...
        var table = '<table style="width:90%; font-family: \'Verdana\';">' +
        ' <tr>' +
        ' <th></th>' +
        ' <th></th>' +

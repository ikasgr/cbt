                                    ...
                                    <table id="table-header-print" style="width: 100%; border: 0;">
                                        <tr>
                                            ...
                                            <td style="width:70%; text-align: center;">
                                                <div style="line-height: 1.1; font-family: 'Verdana'; font-size: 14pt"><?= $setting->sekolah ?></div>
                                                <div style="line-height: 1.1; font-family: 'Verdana'; font-size: 16pt">
                                                    <b>DAFTAR PENGAWAS</b></div>
                                                <div style="line-height: 1.2; font-family: 'Verdana'; font-size: 13pt"><?= strtoupper($jenis_ujian->nama_jenis ?? '' . ' (' . $jenis_ujian->kode_jenis . ')') ?></div>
                                                <div style="line-height: 1.2; font-family: 'Verdana'; font-size: 12pt">
